...
class Login:
    ...
    def reg_submit(self):
        ...
        #print("C:\\Users\\POMPI MAHATO\\PycharmProjects\\finder\\images\\" + filename)

        if resposnse==1:
            shutil.copyfile(self.filename['text'],"C:\\Users\\POMPI MAHATO\\PycharmProjects\\finder\\images\\" +
                            filename)
